    ...
    smoothproducts: function () {
      ...
      d(".sp-loading").hide(),
            ...
            d(this).append(
              ...
              d("a", this).each(function (s) {
                var e = d("img", this).attr("src"),
                  t = d(this).attr("href"),
                  p = "";
                ((0 === s && !i) || d(this).hasClass("sp-default")) &&
                  ((p = ' class="sp-current"'),
                  (a = t),
                  (n = d("img", this)[0].src)),
                  d(this)
        ...
        d(document.body).on("mouseover", function (s) {
          d(".sp-wrap").removeClass("sp-touch").addClass("sp-non-touch"),
            s.preventDefault();
        }),
        ...
        d(document.body).on("click", ".sp-tb-active a", function (s) {
          ...
          d(this)
            .parents(".sp-wrap")
            .find(".sp-large")
            .css({ overflow: "hidden", height: e + "px", width: t + "px" }),
            d(this)
              .addClass("sp-current")
              .parents(".sp-wrap")
              .find(".sp-large a")
            ...
            d(this)
              ...
              .fadeIn(250, function () {
                ...
                d(this)
                  .parents(".sp-wrap")
                  .find(".sp-large")
                  .animate({ height: s }, "fast", function () {
                    d(".sp-large").css({ height: "auto", width: "auto" });
                  }),
                  d(this)
                    .parents(".sp-wrap")
                    .find(".sp-thumbs")
        ...
        d(document.body).on(
          ...
          function (s) {
            ...
            d(this).append('<div class="sp-zoom"><img src="' + e + '"/></div>'),
        ...
        d(document.body).on("click", "#sp-next", function (s) {
          ...
          if (t <= e);
            ...
            e == t - 1 && d("#sp-next").css("opacity", ".1"),
              ...
              d(".sp-selected .sp-thumbs a:eq(" + e + ")").addClass(
                "sp-current"
              ),
        ...
        d(document.body).on("click", "#sp-prev", function (s) {
          ...
          if (
            (s.stopPropagation(),
            (e = (e = d(".sp-lightbox").data("currenteq")) - 1) <= 0)
          );
          else {
            ...
            d("#sp-next").css("opacity", "1"),
              d(".sp-selected .sp-current").removeClass(),
              d(".sp-selected .sp-thumbs a:eq(" + t + ")").addClass(
                "sp-current"
              ),
              d(".sp-selected .sp-large")
                .empty()
                .append("<a href=" + p + '><img src="' + a + '"/></a>'),
              d(".sp-lightbox img").fadeOut(250, function () {
                d(this).remove(),
                  d(".sp-lightbox")
                    .data("currenteq", e)
